...
//! 
//! Perfect. For follow-up questions, I'll keep the answers concise and interview-ready.
//! 
//! ---
//! 
...
//! ---
//! 
//! This is exactly how we'll handle **all follow-up questions**: short, direct, and suitable for speaking during a technical interview.

pub const TOPIC: &str = "Borrowing";
